'''extracts frames and also updates the csv file, change the line's 83,84,86 accordingly'''
import cv2
import os
import pandas as pd
...
def extract_frames(source_dir, target_dir, fps_extract=1, target_size=(512, 512)):
...
if __name__ == "__main__":
    source_dir = r"E:\DataSets\tarangDataset(main)\bharatnatyam\videos"
    target_dir = r"E:\DataSets\TarangAI_Dataset\images\bharatnatyam"
